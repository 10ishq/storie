...
const CartProducts = ({
  ...
  return (
    <div className="flex-wrap w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="flex md:flex-row  w-full justify-between ">
          ...
          <div className="flex flex-col ml-5">
            <a href="#">
              ...
              <p className="text-left hidden xl:block tracking-tight text-gray-900 dark:text-white ">{description}</p>
            </a>
        ...
        <div className="flex w-full p-4 justify-between items-center">
          ...
          <div className="flex justify-center items-center max-h-6">
            ...
            <button
              ...
              className="m-2 p-2 bg-slate-400 h-full p-2 border-red-400 border rounded-md"
            >
              Update Cart
            </button>
          </div>
